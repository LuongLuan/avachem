<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" Async="true" AutoEventWireup="true" CodeBehind="UpdateLeave.aspx.cs" Inherits="AvaChemAdminPanelMobiAPI.UpdateLeave" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>AvaChem | Update Leave</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h1 class="page-title">Update Leave
                        <small>update leave in the system</small>
        </h1>
        <div class="page-bar">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">Update leave</span>
                        </div>
                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <asp:DropDownList class="form-control" ID="ddlUser" ClientIDMode="Static" runat="server" OnChange="handleUser_Change()"></asp:DropDownList><br />
    ...
    <script>
        ...
        $(function () {
            ...
            $("#fuUpload").change(function (event) {
                try {
                    var uploadedFileUrl = getUploadedFileURL(event);
                    if (!uploadedFileUrl) {
                        if (!$(imgProof_id).attr('src')) $(grpImage_class).hide();
                        return;
                    }
                    $(lnkImage_id).attr("href", uploadedFileUrl);
