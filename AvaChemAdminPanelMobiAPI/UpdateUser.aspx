<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="AvaChemAdminPanelMobiAPI.UpdateUser" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>AvaChem | Update User</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-content">
        ...
        <h1 class="page-title">Update User
                        <small>update user in the system</small>
        </h1>
        <div class="page-bar">
                    ...
                    <div class="portlet-body form" runat="server">
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">
                                        Total Credits<label style="color: red">*</label>:</label>
                                    <div class="col-md-5">
                                        <asp:TextBox class="form-control" placeholder="Enter total credits" ID="tbxCredits" runat="server"></asp:TextBox><br />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" style="font-size: 13px">
                                                ...
                                                <tbody id="tbdQ">
                                                    <%foreach (Qualification q in listQ)
                                                        { %>
                                                    <tr id="q_<%Response.Write(q.ID); %>">
                                                        <td id="q_<%Response.Write(q.ID); %>_Name"><%Response.Write(q.Name); %></td>
                                                        <td id="q_<%Response.Write(q.ID); %>_DateObtained"><%Response.Write(q.DateObtained.ToString("dd-MM-yyyy")); %></td>
                                                        <td id="q_<%Response.Write(q.ID); %>_ExpiryDate"><%Response.Write(q.ExpiryDate.ToString("dd-MM-yyyy")); %></td>
                                                        <td class="text-center">
                                                            <button type="button" data-toggle="modal" data-target="#updateQualificationModal" class="btn btn-primary btn-sm"
                                                                onclick="EditQ_Click('<%Response.Write(q.ID); %>')">
                                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                                            </button>
                                                        </td>
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-danger btn-sm"
                                                                onclick="DeleteQ_Click('<%Response.Write(q.ID); %>')">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button causesvalidation="False" type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
