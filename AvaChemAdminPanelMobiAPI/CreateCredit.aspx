<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CreateCredit.aspx.cs" Inherits="AvaChemAdminPanelMobiAPI.CreateCredit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>AvaChem | Add Credit</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-content">
        ...
        <h1 class="page-title">Add Credit
                        <small>add credit record in the system</small>
        </h1>
        <div class="page-bar">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">Add Credit</span>
                        </div>
                    </div>
